...
public class SideBarStudentController {
    ...
    // COUNT(*) FROM registration WHERE studentNumber = ?")) {
    ...
    // e.printStackTrace(); // Handle the exception based on your application's
    // requirements
    // }
...
// s.sportinformation, s.sportquota " +
...
// Connection connection = dataSource.getConnection();
// String sql = "SELECT DISTINCT a.activityid, a.activityname,
// u.uniforminformation, u.uniformquota " +
...
// /*
// * public int getActivityID() { // This getter is not necessary if it's
// already
...
// public String viewPendaftaran(HttpSession session, Model model, StudentBean
// sb) {
// String studentNumber = (String) session.getAttribute("studentNumber");
// // String studentName =
// // String
...
// + "JOIN student S ON S.studentNumber = R.studentNumber WHERE
// R.studentNumber=?";
...
// + "JOIN student S ON S.studentNumber = R.studentNumber WHERE
// R.studentNumber=?";
// PreparedStatement statement2 = connection.prepareStatement(sql2); // Fix
// variable name
...
// + "JOIN student S ON S.studentNumber = R.studentNumber WHERE
// R.studentNumber=?";
// PreparedStatement statement3 = connection.prepareStatement(sql3); // Fix
// variable name
