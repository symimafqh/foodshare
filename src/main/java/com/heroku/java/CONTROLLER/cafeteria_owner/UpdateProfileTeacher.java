...
//     public String updateProfileTeacher(@ModelAttribute("profileTeacher_edit") CafeBean s, HttpSession session, Model model){
...
//     public String updatepasswordteacher(CafeBean t, HttpSession session, Model model) {
//         String teacherUsername = (String) session.getAttribute("teacherUsername");
//         System.out.println("IC Number : " + teacherUsername);
...
//     public String updateProfileAdmin(@ModelAttribute("profileAdmin") CafeBean s, HttpSession session, Model model){
//         String teacherUsername = (String) session.getAttribute("teacherUsername");
//         System.out.println("IC Number : " + teacherUsername);
//         try {
//             Connection connection = dataSource.getConnection();
...
//     public String updatepasswordadmin(CafeBean t, HttpSession session, Model model) {
//         String teacherUsername = (String) session.getAttribute("teacherUsername");
//         System.out.println("IC Number : " + teacherUsername);
